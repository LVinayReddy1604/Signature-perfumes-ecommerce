...
<body>
    ...
    <section class="shop" >
        ...
        <div class="box-container">
            ...
            ?>
            <div class="box">   
                <a href="view_page.php?pid=<?php echo $fetch_cart['pid']; ?>"><img style=" width:100%; height:300px;"src="image/<?php echo $fetch_cart['image']; ?>"></a>
                <div class="price" style="position:relative;">₹<?php echo $fetch_cart['price']; ?></div>
        ...
        <div class="dlt">
        <a href="cart.php?delete_all" class="btn2 <?php echo ($grand_total>0)?'':'disabled'?>" onclick="return confirm('do you want to delete all items in your wishlist')">delete all</a>                
        </div>
        <div class="wishlist_total">
                <p>total amount payable:<span>₹<?php echo $grand_total; ?> /-</span></p>
                <a href="shop.php" class="dlt">continue shopping</a>
                <a href="checkout.php" class="dlt <?php echo ($grand_total>0)?'':'disabled'?>">Proceed to Checkout</a>      
        </div>
    </section>
